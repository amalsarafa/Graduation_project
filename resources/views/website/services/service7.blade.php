...
@section('title','خدمة الفحوصات الطبية المنزلية ')
@section('Navbar')
<!-- Navbar Start -->
    ...
    <div class="container-fluid bg-primary py-5 bg-header">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated slideInDown">الفحوصات الطبية المنزلية </h1>
...
<div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <h2 class="mb-4">الفحوصات الطبية المنزلية</h2>
                <p>في <strong>MHW Care</strong>، نقدم خدمات الفحوصات الطبية المنزلية التي تتيح لك إجراء التحاليل والفحوصات الطبية في راحة منزلك دون الحاجة للذهاب إلى المختبرات. نسعى لتقديم خدمة مريحة وسريعة ودقيقة.</p>
                <h4 class="mt-4">الخدمات المقدمة:</h4>
                <ul>
                    <li>سحب عينات الدم من المنزل</li>
                    <li>إجراء الفحوصات الطبية الروتينية</li>
                    <li>تقديم نتائج الفحوصات بسرعة ودقة</li>
                    <li>تنسيق مع أطباء لتفسير النتائج</li>
                </ul>
                <h4 class="mt-4">الفوائد:</h4>
                <p>تتيح هذه الخدمة توفير الوقت والجهد، مع ضمان راحة المرضى وتقديم رعاية طبية عالية الجودة.</p>
            </div>
            <div class="col-lg-4">

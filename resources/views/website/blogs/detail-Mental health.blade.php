...
@section('title','المدونة-الصحة النفسية')
@section('Navbar')
<!-- Navbar Start -->
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/mental health1.jpg" alt="صورة المقال">
                        <h1 class="mb-4">الصحة النفسية: أساس لحياة متوازنة</h1>
                        <p>الصحة النفسية جزء لا يتجزأ من صحتنا العامة، وهي مفتاح لحياة مليئة بالسعادة والإنتاجية. عندما نعتني بصحتنا النفسية، نتمكن من مواجهة التحديات اليومية بثقة أكبر.</p>
                        <p>من الأمور الهامة لتحقيق صحة نفسية جيدة: تخصيص وقت للراحة والاسترخاء، ممارسة الرياضة بانتظام، والحفاظ على توازن بين الحياة العملية والشخصية. أيضًا، التواصل مع الأصدقاء والعائلة يمكن أن يكون له تأثير إيجابي كبير على حالتك النفسية.</p>
                        <p>إذا شعرت بالضغوط أو القلق، لا تتردد في طلب المساعدة من مختص في الصحة النفسية. العناية بصحتك النفسية ليست رفاهية، بل هي ضرورة لحياة صحية ومتوازنة.</p>
                    </div>
                    <!-- Blog Detail End -->

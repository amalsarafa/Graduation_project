    ...
    function t(e, t) {
      ...
      (a[0].innerHTML =
        ...
        (a[3].innerHTML =
          ...
          n[3] +
          '">'),
        (a[4].innerHTML = '<a class="edit" href="">حفظ</a>'),
        (a[5].innerHTML = '<a class="cancel" href="">الغاء </a>');
    }
    function n(e, t) {
      var n = $("input", t);
      e.fnUpdate(n[0].value, t, 0, !1),
        ...
        e.fnUpdate('<a class="edit" href="">تعديل </a>', t, 4, !1),
        e.fnUpdate('<a class="delete" href="">حذف</a>', t, 5, !1),
        e.fnDraw();
    }

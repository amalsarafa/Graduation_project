      ...
      e.validate({
        ...
        errorPlacement: function (e, r) {
          ...
          i.removeClass("fa-check").addClass("fa-warning"),
            i
              .attr("data-original-title", e.text())
    ...
    i = function () {
      ...
      e.on("submit", function () {
        ...
        e.validate({
          ...
          messages: {
            membership: { required: "مهم ارجو  تعئبة السؤال " },
            service: {
              required: "",
              minlength: jQuery.validator.format(
                ""
          ...
          errorPlacement: function (e, r) {
            r.parent(".input-group").size() > 0
              ...
              : r.parents(".radio-list").size() > 0
              ? e.appendTo(
                  r.parents(".radio-list").attr("data-error-container")
                )
              : r.parents(".radio-inline").size() > 0
              ? e.appendTo(
                  r.parents(".radio-inline").attr("data-error-container")
                )
              : r.parents(".checkbox-list").size() > 0
              ? e.appendTo(
                  r.parents(".checkbox-list").attr("data-error-container")
                )
              : r.parents(".checkbox-inline").size() > 0
              ? e.appendTo(
                  r.parents(".checkbox-inline").attr("data-error-container")
                )
              : e.insertAfter(r);
          },
          invalidHandler: function (e, t) {

var Login = (function () {
    var e = function () {
            $(".login-form").validate({
                ...
                messages: { username: { required: "السم ." }, password: { required: "كلمة المرور مهمة ." } },
        ...
        i = function () {
            ...
            jQuery().select2 &&
                ...
                jQuery("#register-btn").click(function () {
                    jQuery(".login-form").hide(), jQuery(".register-form-d").hide(), jQuery(".register-form-p").show();
                }),
                jQuery("#register-back-btn").click(function () {
                    jQuery(".login-form").show(), jQuery(".register-form-p").hide(),jQuery(".register-form-d").hide();;
                });
                jQuery("#register-btn2").click(function () {
                    jQuery(".login-form").hide(), jQuery(".register-form-d").show(), jQuery(".register-form-p").hide();
                }),
